...
export default createWidget('page-stats', {
  ...
  html(attrs, state) {
   ...
   if (trust_level === 4) { var graff =  '<br><br><img src="https://toxu.ru/uploads/default/original/2X/6/6d31dd3cefe0a112c68dfbf60c6a66bd827df2f2.jpg" alt="Toxu" width="455" height="324"><br><br> <b>Вносите предложения:</b> <a href="" target="_blank">переводы</a>, дизайн - <a href="https://toxu.ru/t/mobilnyj-dizajn-i-vse-chto-s-nim-svyazano/1635" target="_blank">мобильный</a> и <a href="https://toxu.ru/t/oshibki-v-dizajne-pk-publikuem-tut/1862" target="_blank">ПК</a>, <a href="https://toxu.ru/t/kategorii-udobstvo-dostup/1090" target="_blank">категории/удобство/доступ</a> или юзабилити и т.д.';}   
      ...
      var dov = 'Поздравляем, ваш уровень: <span style="color: #335599;"><b>Новичок!</b></span><br><br>Теперь Вы можете писать во все разделы, а при условии вступления в <a target="_blank" href="https://toxu.ru/groups">Группы</a>, и в дополнительные!';
      var dov_2 = 'Ознакомьтесь более подробно с главным нашим документом: <a target="_blank" href="https://toxu.ru/t/poleznye-i-bespoleznye-otvety/202"><b>Политикой полезности.</b></a> Это поможет вам приблизится к следующему уровню доверия и откроет новые возможности на сайте.<br><br>Теперь вам доступны личные сообщения. А при жалобе, вы можете написать непосредственно автору, избегая отсылку жалобы администрации.<br><br>Еще Вы можете:<br><br><ul><il>- <a target="_blank" href="https://toxu.ru/u/'+ username +'/preferences/interface">Настроить дизайн</a>, и выбрать центральную страницу сайта для себя.</il><br><il>- <a target="_blank" href="https://toxu.ru/t/sajt-toxu-ru-v-seti/2031">Присоединиться</a> к любой группе в социальных сетях, где представлен наш сайт.</il></ul>';}
