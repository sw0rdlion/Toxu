...
export default createWidget('page-stats', {
  ...
  html(attrs, state) {
    ...
    if (currentUser) {
      ...
      var dov = 'Поздравляем, ваш уровень: <b>Посетитель</b>!<br><br>Вы пожете писать только в категории: <b>Песочница</b> и в дополнительных категориях, при условии вступления в <a target="_blank" href="https://toxu.ru/groups">Группы</a>. Вступайте в них!<br><br>Вам <a target="_blank" href="https://toxu.ru/u/conter/messages">пришло письмо</a> от нашего <b>ToxBot</b>-а, прочитайте его получите награду после прохождения обучения.<br>';
