...
export default createWidget('page-stats', {
  ...
  html(attrs, state) {
    ...
    if (currentUser) {
      ...
      var dov_2 = 'Ознакомьтесь более подробно, что такое <a target="_blank" href="https://toxu.ru/t/uroven-doveriya-na-sajte-toxu-ru/61">Уровень доверие</a> на сайте, и с главным нашим документом: <a target="_blank" href="https://toxu.ru/t/poleznye-i-bespoleznye-otvety/202">Политикой полезности.</a><br><br>Теперь вам доступны личные сообщения. А при жалобе, вы можете написать непосредственно автору, избегая отсылку жалобы администрации.<br><br>Вы так же можете:<br><br><ul><il>- Настроить дизайн для себя. У нас несколько вариантов дизайна.</il><br><il>- Выбрать свою центральную страницу.</il><br><il>- Полностью заполнить свой профиль.</il></ul>';}
