...
export default createWidget('page-stats', {
  ...
  html(attrs, state) {
    ...
    if (currentUser) {
      ...
      var dov = 'Поздравляем, ваш уровень: <b>Посетитель</b>!<br><br>Вы пожете писать только в категории: <b>Песочница</b> и в дополнительных категориях, при условии вступления в <a target="_blank" href="https://toxu.ru/groups">Группы</a>. Вступайте в них!<br>Вам пришло письмо от нашего ToxBot-а, прочитайте его получите награду после прохождения обучения.';
