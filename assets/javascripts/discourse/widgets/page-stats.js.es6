...
export default createWidget('page-stats', {
  ...
  html(attrs, state) {
   ...
   if (trust_level === 3) { 
   var graff =  'Вам  стала доступна возможность <b>редактировать</b> вопросы, вносить и добавлять различные теги, менять категорию.<br><br><img src="/uploads/default/original/2X/9/9f1380a89edd873b73fe8d7f4032151e27e93eb1.gif" alt="Редактирование-вопроса" width="650" height="100"><br><br>Создавать вопросы/темы для коллективной работы в режиме Wiki.<br><br><img src="/uploads/default/original/2X/c/c9e035ffdf1a64efb60d38aa7a372086c28295e7.gif" alt="Add-Wiki" width="383" height="146"><br><br>Писать в категорию <a href="https://toxu.ru/c/toxu/blog" target="_blank">блог</a><br><br>Обязательно ознакомьтесь со следующими материалами: <a target="_blank" href="https://toxu.ru/t/vojna-pravok-na-toxu/1281">война правок</a> на сайте, и <a target="_blank" href="https://toxu.ru/t/kakovy-rekomendaczii-i-politika-dlya-redaktirovaniya-voprosa-na-toxu-ru/934">каковы рекомендации и политика для редактирования вопроса</a>.';}
