...
export default createWidget('page-stats', {
  ...
  html(attrs, state) {
    ...
    if (currentUser) {
      ...
      var dov = 'Поздравляем, ваш уровень: <b>Посетитель</b>!<br><br>Вы можете писать только в категории: <b>Песочница</b> и в дополнительных категориях, при условии вступления в <a target="_blank" href="https://toxu.ru/groups">Группы</a>. Вступайте в них!<br><br>Вам <a target="_blank" href="https://toxu.ru/u/conter/messages">пришло письмо</a> от нашего <b>ToxBot</b>-а, прочитайте его и получите награду <img src="https://toxu.ru/images/emoji/twitter/trophy.png?v=5" class="emoji"> псле прохождения ознакомительной экскурсии. Это поможет вам приблизится к следующему уровню доверия и откроет новые возможности на сайте.<br>';
