...
export default createWidget('page-stats', {
  ...
  html(attrs, state) {
   ...
   if (trust_level === 4) { var graff =  '<br><br><img src="https://toxu.ru/uploads/default/original/2X/6/6d31dd3cefe0a112c68dfbf60c6a66bd827df2f2.jpg" alt="Toxu" width="455" height="324"><br><br> <b>Вносите предложения:</b> <a href="" target="_blank">переводы</a>, дизайн - <a href="https://toxu.ru/t/mobilnyj-dizajn-i-vse-chto-s-nim-svyazano/1635" target="_blank">мобильный</a> и <a href="https://toxu.ru/t/oshibki-v-dizajne-pk-publikuem-tut/1862" target="_blank">ПК</a>, <a href="https://toxu.ru/t/kategorii-udobstvo-dostup/1090" target="_blank">категории/удобство/доступ</a> или юзабилити и т.д.';}   
      ...
      var dov_2 = 'Ознакомьтесь более подробно с главным нашим документом: <a target="_blank" href="https://toxu.ru/t/poleznye-i-bespoleznye-otvety/202">Политикой полезности.</a> Это поможет вам приблизится к следующему уровню доверия и откроет новые возможности на сайте.<br><br>Теперь вам доступны <a target="_blank" href="https://toxu.ru/u/'+ username +'/messages"><b>личные сообщения</b></a>. А при жалобе, вы можете написать непосредственно автору, избегая отсылку жалобы администрации.<br><br>Воспользуйтесь личными сообщениями и получите грамоту, отправив вашему боту письмо нажав на <a target="_blank"  href="http://toxu.ru/new-message?username=ToxBot&title=Привет%20Бот!&body=@ToxBot%20справка%20Привет,%20давай%20общаться?">эту ссылку</a>.<br><br><i>Еще Вы можете:</i> <a target="_blank" href="https://toxu.ru/u/'+ username +'/preferences/interface">настроить дизайн</a>, и выбрать центральную страницу сайта для себя. И <a target="_blank" href="https://toxu.ru/t/sajt-toxu-ru-v-seti/2031">присоединиться</a> к любой группе в социальных сетях, где представлен наш сайт.</il></ul>';}
