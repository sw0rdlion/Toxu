...
export default createWidget('profile-t', {
  ...
  html(attrs, state) {
    ...
    if (currentUser) {
      ...
      if (trust_level === 0) { var doverie = I18n.t("main.d0-you"); var coll = 'col0'; var dopp = '<div class="werng"><i class="fa fa-info" aria-hidden="true"></i> Прочитайте, проваши возможности <a class="" href="https://toxu.ru/stats">нажав на эту ссылку</a>.</div>';}
      if (trust_level === 1) { var doverie = I18n.t("main.d1-you"); var coll = 'col1'; var dopp = '<div class="werng"><i class="fa fa-gift" aria-hidden="true"></i> У вас появились новые возможности. Прочитайте про них <a class="" href="https://toxu.ru/stats">нажав на эту ссылку</a>.</div>';}
