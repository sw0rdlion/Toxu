...
export default createWidget('profile-t', {
  ...
  html(attrs, state) {
    ...
    if (currentUser) {
      ...
      if (trust_level === 0) { var doverie = I18n.t("main.d0-you"); var coll = 'col0'; var dopp = '<hr><span style="font-size: 14px;"><a href="https://toxu.ru/stats"><span style="color:#f56400;">Прочтите</span></a> - рекомендации</span><br><br>';}
...
<span class="${coll}"><a class="${coll}" title="Посмотрите вашу статистику"  href="https://toxu.ru/stats"> - ${doverie}</a></span><br>
${dopp}
