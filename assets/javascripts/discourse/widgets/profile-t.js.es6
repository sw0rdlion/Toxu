...
if (trust_level === 2) { var doverie = I18n.t("main.d2-you"); var dopp = '<div class="werng"><i class="fa fa-gift" aria-hidden="true"></i> Ваш уровень доверие стал: <a class="und" href="https://toxu.ru/stats"><i>участник</i></a>.</div>';}
