...
if (trust_level === 0) { var doverie = I18n.t("main.d0-you"); var dopp = '<div class="werng"><i class="fa fa-info" aria-hidden="true"></i> Прочитайте, про ваши возможности <a class="und" href="https://toxu.ru/stats">нажав на эту ссылку</a>.</div>';}
