...
if (trust_level === 4) { var doverie = I18n.t("main.d4-you"); var dopp = '<div class="werng"><i class="fa fa-gift" aria-hidden="true"></i> Об уровне доверия - <a class="cvet" href="https://toxu.ru/stats"><i>лидер</i></a>.</div>';}
