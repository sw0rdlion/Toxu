...
<a class="nound2" title="Посмотрить мои возможности"  href="https://toxu.ru/stats">${doverie}</a><br>
${dopp}
<a class="nound2" title="Мои вопросы и ответы" href="https://toxu.ru/posted">${I18n.t('main.qa-you')}</a> -  
<a class="nound2" title="Мои закладки" href="https://toxu.ru/bookmarks">${I18n.t('main.bookmark-you')}</a> - 
<a class="nound2" title="Моя почта" href="https://toxu.ru/u/${username}/messages">${I18n.t('main.mail-you')}</a>
<hr></div>`})
