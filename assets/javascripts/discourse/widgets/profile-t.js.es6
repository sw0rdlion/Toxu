...
if (trust_level === 0) { var doverie = I18n.t("main.d0-you"); var dopp = '<div class="werng-mob"><div class="werng"><i class="fa fa-gift" aria-hidden="true"></i> Прочтите про ваши возможности <a class="cvet" href="https://toxu.ru/stats">используя эту ссылку</a></div></div>';}
if (trust_level === 1) { var doverie = I18n.t("main.d1-you"); var dopp = '<div class="werng"><i class="fa fa-gift" aria-hidden="true"></i> У вас появились новые возможности. Прочитайте про них <a class="cvet" href="https://toxu.ru/stats">нажав на эту ссылку</a>.</div>';}
