...
if (trust_level === 1) { var doverie = I18n.t("main.d1-you"); var dopp = '<div class="werng"><i class="fa fa-gift" aria-hidden="true"></i> У вас появились <a class="cvet" href="https://toxu.ru/stats">новые возможности. Поздравляем!</a></div>';}
