...
export default createWidget('profile-t', {
  ...
  html(attrs, state) {
    ...
    if (currentUser) {
      ...
      if (trust_level === 0) { var doverie = I18n.t("main.d0-you"); var coll = 'col0'; var dopp = '<hr>Прочитайте про новые возможности <a class="menu-prof menu" href="https://toxu.ru/stats"><b>нажам на эту ссылку</b></a>.<hr>';}
      if (trust_level === 1) { var doverie = I18n.t("main.d1-you"); var coll = 'col1'; var dopp = '<hr>У вас появились <span style="font-size: 14px;color:#339900;">новые возможности</span>. Прочитайте про них <a class="menu-prof menu" href="https://toxu.ru/stats"><b>нажав на эту ссылку</b></a>.<hr>';}
