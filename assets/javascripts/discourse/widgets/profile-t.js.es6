...
export default createWidget('profile-t', {
  ...
  html(attrs, state) {
    ...
    if (currentUser) {
      ...
      if (trust_level === 1) { var doverie = I18n.t("main.d1-you"); var coll = 'col1'; var dopp = '<hr>У вас <span style="font-size: 14px;color:#339900;">новый уровень доверия!</span> Прочитайте про новые возможности <a class="menu-prof menu" href="https://toxu.ru/stats"><b>нажав на эту ссылку</b></a>.<hr>';}
