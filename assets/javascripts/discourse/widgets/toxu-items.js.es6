...
<div class="add-qa"><a href="https://toxu.ru/login" class="addqa" title="Задать вопрос"> <i class="fa fa-plus d-icon d-icon-plus"></i> <span class="d-button-label">Задать вопрос</span></a></div>
</div>
